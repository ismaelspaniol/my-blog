    ...
    return (
        ...
        >
            ...
            <ul
                className={
                    nav
                        ? "fixed sm:hidden left-0 top-0 w-[50%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500"
            ...
            >
                ...
                {navItems.map((item: InavItem) => (
                    <li
                        key={item.id}
                        className="p-2 border-b rounded-xl hover:bg-[#00df9a] duration-300 hover:text-black cursor-pointer border-gray-600 flex items-center"
                    >
                        <Link
